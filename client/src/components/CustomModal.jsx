    ...
    return (
        <div className={`modal-overlay ${fade ? 'fade-out' : ''}`}>
            <div className={`modal-content ${fade ? 'fade-out' : ''}`}>
                ...
                <Button variant="contained" color="secondary" onClick={handleFadeOut} style={{ backgroundColor: 'pink' }}>
                    Cancel
                </Button>
                <Button variant="contained" color="secondary" onClick={handleConfirm} style={{ backgroundColor: 'pink' }}>
                    Delete
                </Button>
            </div>
        </div>
